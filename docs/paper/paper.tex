...
\begin{itemize}
    ...
    \item \textbf{Multiple Coders}: The researcher independently reviewed sessions in progress and post hoc to identify patterns
    ...
    \begin{itemize}
        ...
        \item \textbf{Linguistic Alignment Measurement}: Calculated cosine similarity between participant embeddings to detect mirroring patterns and validate peer influence observations. Average linguistic alignment across conversations was \exponedataAverageLinguisticAlignment{}, with \exponedataHighAlignmentConversations{} conversations showing high alignment (>0.8)
        \item \textbf{Emotion Trajectory Analysis}: Applied transformer-based emotion detection (DistilRoBERTa) to track emotional convergence patterns across conversations. Average emotional convergence score was \exponedataAverageEmotionalConvergence{}, indicating moderate emotional mirroring between participants
