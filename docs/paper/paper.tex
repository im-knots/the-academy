...
\title{\theacademy{}: An Integrated Platform for AI Dialogue Research with Real-Time Analysis and Intervention Capabilities}
...
\toprule
\textbf{Platform Feature Tested} & \textbf{Participants} & \textbf{Messages} & \textbf{Real-time Analyses} & \textbf{Interventions} & \textbf{Session Duration} \\
\midrule
Standard 2-participant analysis & 2 & 42 & 7 & 1 & 45 minutes \\
Extended multi-participant tracking & 4 & 100+ & 29 & 3 & 2.5 hours \\
\bottomrule
\end{tabular}
...
\begin{itemize}
    \item \textbf{Analysis Latency}: Mean 147ms per analysis cycle (σ = 23ms)
