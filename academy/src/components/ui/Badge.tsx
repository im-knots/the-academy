  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        ollama: "border-transparent bg-gradient-to-r from-lime-100 to-green-100 text-lime-800 shadow hover:from-lime-200 hover:to-green-200",
        deepseek: "border-transparent bg-gradient-to-r from-fuchsia-100 to-pink-100 text-fuchsia-800 shadow hover:from-fuchsia-200 hover:to-pink-200",
        mistral: "border-transparent bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 shadow hover:from-yellow-200 hover:to-amber-200",
        cohere: "border-transparent bg-gradient-to-r from-rose-100 to-red-100 text-rose-800 shadow hover:from-rose-200 hover:to-red-200",
